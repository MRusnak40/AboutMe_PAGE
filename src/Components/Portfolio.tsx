                ...
                */}
                <div className="p-4 sm:p-8 md:p-12 space-y-4 sm:space-y-6 md:space-y-8">
                  ...
                  */}
                  ...
                  {/* Tlačítko - uhlazenější a lépe proporční na úzkých displejích */}
                  <div className="pt-2 md:pt-4">
                    <a 
                      href={project.github} 
                      target="_blank" 
                      rel="noreferrer"
                      className="inline-flex items-center justify-center w-full sm:w-auto gap-2 md:gap-3 px-4 md:px-8 py-2.5 md:py-4 bg-white text-black hover:bg-red-600 hover:text-white border-2 border-transparent transition-all rounded-lg md:rounded-xl font-bold text-sm md:text-lg"
                    >
                      View on GitHub &rarr;
                    </a>
